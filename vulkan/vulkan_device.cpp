...
void VulkanDevice::createSurface(GLFWwindow* window, VkInstance instance, VkSurfaceKHR* surface) {
...
void VulkanDevice::cleanup(VkInstance instance, VkSurfaceKHR surface) {
